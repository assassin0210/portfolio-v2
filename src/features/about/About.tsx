        ...
        <AnimateFromSide type={'right'}>
          <div className={'space-y-3 '}>
            <P16>
              ...
              web development. Fast forward to today. I had the honor of
              creating software for an{' '}
              <a
            ...
            <P16>
              ...
              who share a passion for pushing boundaries and driving innovation
              in frontend development. They are collaborative, supportive, and
              encourage open communication and idea exchange. In this team,
              there is a strong emphasis on continuous learning and professional
              growth, with opportunities to explore emerging technologies and
            ...
            <ul className={'list-disc text-gray-100 pl-2 space-y-2'}>
              <li>
                <P16>
                  ...
                  professional development. I aim to expand my skill set and
                  gain new experiences that will make me a more effective and
                  valuable frontend developer.
                </P16>
              </li>
              <li>
                <P16>
                  ...
                  strive to work in an environment that supports my ambitions
                  and offers engaging and meaningful projects.
                </P16>
              </li>
            </ul>
          </div>
