  ...
  return (
    <AnimateFromSide type={'right'}>
      <div className={'space-y-3'}>
        <P16>
          Back in 2019, I decided to try my hand at building user interfaces and
          have since immersed myself in the exciting world of coding and web
          development. Fast forward to today. I had the honor of creating
          software for an{' '}
        ...
        <P16 className={'dark:text-white text-black'}>
          <i>What does my dream team look like?</i>
        </P16>
        <P16>
          My dream team consists of highly skilled and motivated individuals who
          share a passion for pushing boundaries and driving innovation in
          frontend development. They are collaborative, supportive, and
          encourage open communication and idea exchange. In this team, there is
          a strong emphasis on continuous learning and professional growth, with
          opportunities to explore emerging technologies and stay at the
        ...
        <P16>
          ...
          excellence and exceed expectations in delivering high-quality frontend
          solutions.
        </P16>
        <P16 className={'dark:text-white text-black'}>
        ...
        <ul className={'list-disc text-gray-100 pl-2 space-y-2'}>
          ...
          <li>
            <P16>
              I made the decision to leave as my previous company didn't provide
              sufficient opportunities for growth and advancement. I strive to
              work in an environment that supports my ambitions and offers
